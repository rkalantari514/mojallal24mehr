...
class FactorAdmin(admin.ModelAdmin):
    list_display = ['acc_year','pdate', 'code', 'create_time', 'per_code', 'person','date','mablagh_factor', 'takhfif', 'darsad_takhfif', 'darsad_takhfif_end_factor']
...
class SanadDetailAdmin(admin.ModelAdmin):
    list_display = ['acc_year','__str__', 'code', 'tarikh', 'date', 'kol', 'moin', 'tafzili', 'sharh', 'bed', 'bes', 'curramount',
                    'is_active', 'is_analiz', 'cheque_id', 'syscomment','person','factor','kala']
...
class BedehiMoshtariAdmin(admin.ModelAdmin):
    list_display = ('moin','tafzili','person', 'total_mandeh','loans_total', 'total_with_loans','from_last_daryaft','sleep_investment')
