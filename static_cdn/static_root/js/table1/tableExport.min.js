...
(function ($) {
    $.fn.tableExport = function (options) {
        ...
        if (defaults.type === "csv" || defaults.type === "tsv" || defaults.type === "txt") {
            ...
            let save_data;
            if (defaults.jsonScope === "head") save_data = JSON.stringify(jsonHeaderArray); else if (defaults.jsonScope === "data") save_data = JSON.stringify(jsonArray); else save_data = JSON.stringify({
            ...
            if (defaults.pdfmake.enabled === true) {
                ...
                $(el).filter(function () {
                    ...
                    docDefinition.content.push({
                        table: {
                            ...
                            layout: "noBorders", hLineStyle: function (i, node) {
                                return 0
                ...
                loadImages(teOptions, function () {
                    $(el).filter(function () {
                        ...
                        teOptions.rows = [];
                        teOptions.teCells = {};
                        if (typeof teOptions.onTable === "function") if (teOptions.onTable($(this), defaults) === false) return true;
                        ...
                        if (typeof atOptions.drawHeaderCell !== "function") {
                            atOptions.drawHeaderCell = function (cell, data) {
                                ...
                                if ((colopt.style.hasOwnProperty("hidden") !== true || colopt.style.hidden !== true) && colopt.rowIndex >= 0) return prepareAutoTableText(cell, data, colopt); else return false
                            }
                        }
                        ...
                        $($rows).each(function () {
                            ...
                            ForEachVisibleCell(this, "td,th", rowIndex, $head_rows.length + $rows.length, function (cell, row, col) {
                                ...
                                if (typeof teOptions.columns[colKey] === "undefined") {
                                    obj = {title: "", key: colKey, style: {hidden: true}};
        ...
        function collectImages(cell, elements, teOptions) {
            if (typeof cell !== "undefined" && cell !== null) {
                if (cell.hasAttribute("data-tableexport-canvas")) {
                    ...
                    teOptions.images[imgId] = {url: '[data-tableexport-canvas="' + imgId + '"]', src: null}
                } else if (elements !== "undefined" && elements != null) {
                    elements.each(function () {
                        if ($(this).is("img")) {
                            const imgId = strHashCode(this.src);
                            teOptions.images[imgId] = {url: this.src, src: this.src}
                        }
        ...
        function loadImages(teOptions, callback) {
            ...
            if (typeof teOptions.images !== "undefined") {
                for (let i in teOptions.images) if (teOptions.images.hasOwnProperty(i)) loadImage(teOptions.images[i])
            }
                    ...
                    if (typeof defaults.onCellHtmlData === "function") {
                        ...
                        $.each(html, function () {
                            if ($(this).is("input")) {
                                ...
                                if (typeof $(this).html() === "undefined") htmlData += $(this).text(); else if (jQuery().bootstrapTable === undefined || $(this).hasClass("fht-cell") === false && $(this).hasClass("filterControl") === false && $cell.parents(".detail-view").length === 0) htmlData += $(this).html();
                                if ($(this).is("a")) {
        ...
        function getCellStyles(cell) {
            ...
            const result = {
                style: {
                    ...
                    fstyle: f
                }, colspan: getColspan(cell), rowspan: getRowspan(cell)
            };
            if (cell !== null) {
                const r = cell.getBoundingClientRect();
                result.rect = {width: r.width, height: r.height}
            }
            return result
        }
        ...
        function jsPdfApplyStyles(styles) {
            const arr = [{func: jsPdfDoc.setFillColor, value: styles.fillColor}, {
        ...
        function jsPdfHooksData(additionalData) {
            ...
            const data = {pageCount: jsPdfPageCount, settings: jsPdfSettings, table: jsPdfTable, cursor: jsPdfCursor};
