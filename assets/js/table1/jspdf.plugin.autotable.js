...
(function (API) {
    ...
    var themes = {
        ...
        grid: {
            table: {fillColor: 255, textColor: 80, fontStyle: "normal", lineWidth: .1, fillStyle: "DF"},
    ...
    API.autoTableHtmlToJson = function (table) {
        var data = [], headers = [], header = table.rows[0], tableRow, rowData, i, j;
    ...
    function applyStyles(styles) {
        var arr = [{func: doc.setFillColor, value: styles.fillColor}, {
    ...
    function hooksData(additionalData) {
        ...
        var data = {pageCount: pageCount, settings: settings, table: table, cursor: cursor};
