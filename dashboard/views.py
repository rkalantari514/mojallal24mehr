...
def YealyChart(request):
    ...
    # دیکشنری‌ها برای نگهداری داده‌های هر نمودار
    ...
    for report in all_monthly_reports:
        try:
            ...
            print(f"Error processing monthly report: Year {report.year}, Month {report.month}, Error: {e}")
            pass
    ...
    # تولید datasets برای بهای تمام شده کالای فروخته شده
    chart_datasets_baha_tamam_forosh_by_year = []
    color_index = 0
    for year_val in sorted(yearly_monthly_baha_tamam_forosh_data.keys()):
        chart_datasets_baha_tamam_forosh_by_year.append({
            'label': f'بهای تمام شده فروش {year_val}',
            'data': yearly_monthly_baha_tamam_forosh_data[year_val],
            'backgroundColor': colors_for_yearly_chart[color_index % len(colors_for_yearly_chart)],
            'borderColor': border_colors_for_yearly_chart[color_index % len(border_colors_for_yearly_chart)],
            'borderWidth': 1,
            'barPercentage': 0.8,
    ...
    # تولید datasets برای سود ناویژه
    chart_datasets_sood_navizhe_by_year = []
    color_index = 0
    for year_val in sorted(yearly_monthly_sood_navizhe_data.keys()):
        chart_datasets_sood_navizhe_by_year.append({
            'label': f'سود ناویژه {year_val}',
            'data': yearly_monthly_sood_navizhe_data[year_val],
            'backgroundColor': colors_for_yearly_chart[color_index % len(colors_for_yearly_chart)],
            'borderColor': border_colors_for_yearly_chart[color_index % len(border_colors_for_yearly_chart)],
            'borderWidth': 1,
            'barPercentage': 0.8,
    ...
    # تولید datasets برای سود ویژه
    chart_datasets_sood_vizhe_by_year = []
    color_index = 0
    for year_val in sorted(yearly_monthly_sood_vizhe_data.keys()):
        chart_datasets_sood_vizhe_by_year.append({
            'label': f'سود ویژه {year_val}',
            'data': yearly_monthly_sood_vizhe_data[year_val],
            'backgroundColor': colors_for_yearly_chart[color_index % len(colors_for_yearly_chart)],
            'borderColor': border_colors_for_yearly_chart[color_index % len(border_colors_for_yearly_chart)],
            'borderWidth': 1,
            'barPercentage': 0.8,
    ...
    context = {
        ...
        'chart_datasets_sood_navizhe_by_year': chart_datasets_sood_navizhe_by_year,
        'chart_datasets_sood_vizhe_by_year': chart_datasets_sood_vizhe_by_year,
    }
