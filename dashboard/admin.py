...
class MonthlyReportAdmin(admin.ModelAdmin):
    list_display = ('year', 'month', 'month_name', 'month_first_day', 'month_last_day', 'khales_forosh', 'baha_tamam_forosh', 'sayer_hazine', 'sayer_daramad', 'sood_navizhe', 'sood_vizhe', 'asnad_pardakhtani')
